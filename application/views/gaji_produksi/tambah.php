  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Tambah Gaji Produksi</div>
      </div>
    </div>
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('tambah-gaji-produksi'); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6 form-group">
                    ...
                    <input type="date" name="tanggal_pencairan" class="form-control" value="<?= set_value('tanggal_pencairan'); ?>" required="">
