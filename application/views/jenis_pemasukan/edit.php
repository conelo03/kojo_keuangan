  ...
  <section class="section">
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('edit-jenis-pemasukan/'.$jp['id_jenis_pemasukan']); ?>" method="post" enctype="multipart/form-data">
              <div class="card-header">
                <h4>Form Edit Jenis Pemasukan</h4>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12 form-group">
                    <label>Jenis Pemasukan</label>
                    <input type="text" name="jenis_pemasukan" class="form-control" value="<?= set_value('jenis_pemasukan', $jp['jenis_pemasukan']); ?>" required="">
